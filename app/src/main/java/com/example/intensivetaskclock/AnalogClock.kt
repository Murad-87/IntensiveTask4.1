package com.example.intensivetaskclock
...
class AnalogClock(
    ...
    private fun setUpAttributes(attributes: AttributeSet?) {
        val typedArray =
            context.theme.obtainStyledAttributes(attributes, R.styleable.AnalogClock, 0, 0)

        lightBackgroundColor = ContextCompat.getColor(
            context,
            typedArray.getResourceId(
                R.styleable.AnalogClock_lightBackgroundColor,
        ...
        lightShadowColor = ContextCompat.getColor(
            context,
            typedArray.getResourceId(
                R.styleable.AnalogClock_lightShadowColor,
        ...
        darkShadowColor = ContextCompat.getColor(
            context,
            typedArray.getResourceId(
                R.styleable.AnalogClock_darkShadowColor,
        ...
        minHourHandsColor = ContextCompat.getColor(
            context,
            typedArray.getResourceId(
                R.styleable.AnalogClock_minHourHandsColor,
        ...
        iconColor = ContextCompat.getColor(
            context,
            typedArray.getResourceId(
                R.styleable.AnalogClock_iconColor,
                R.color.defaultIconColor
            )
        )
        iconSize = TypedValue.applyDimension(
            TypedValue.COMPLEX_UNIT_PX,
            typedArray.getDimension(R.styleable.AnalogClock_iconSize, iconSize),
            context.resources.displayMetrics
        )
